...
const runModes = [{ value: 'single', label: 'Decision Run' }];
...
export function StockAnalyzerNode({
  ...
  const [tickers, setTickers] = useNodeState(id, 'tickers', 'LED lamp,phone case');
  ...
  // Check if decision flow can run
  const canRunTradeDecision = canRun && tickers.trim() !== '';
  
  // Add keyboard shortcut for Cmd+Enter / Ctrl+Enter to run decision flow.
                ...
                <div className="text-subtitle text-primary flex items-center gap-1">
                  <Tooltip delayDuration={200}>
                    <TooltipTrigger asChild>
                      <span>Products / Keywords</span>
                    </TooltipTrigger>
                    <TooltipContent side="right">
                      You can add multiple product keywords using commas.
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button 
                    ...
                    disabled={!canRunTradeDecision && !showAsProcessing}
                  >
                    {showAsProcessing ? (
